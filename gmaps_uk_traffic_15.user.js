...
(function(){
	...
	unsafeWindow.createTrafficMarker = function (lat, lon, html, src, type, start, stp,  image, alat, alon) {
		var icon = new GIcon();
	...
	unsafeWindow.createTrafficCountyMarker = function (html, title, lat, lon){
		var point = new GPoint(lon,lat);
	...
	unsafeWindow.setupTraffic = function (){
		var lo = document.getElementById('toggle');
		lo.innerHTML = "Loading Counties...";
		//alert("Called sT");
		//place backstage logo
		wICon	= new GIcon();
		wICon.image = "http://www.blueghost.pwp.blueyonder.co.uk/bg_site/bbc_v2.png";
	...
	unsafeWindow.goToTraffic = function (loc, lat, lon, id, title){
	...
	unsafeWindow.removeTraffic = function (loc, lat, lon, id, title){
		var index = 0;
	 ...
	 */
	unsafeWindow.resetTraffic = function (){
		//not yet implemented
	}	
	
	unsafeWindow.removeAllTraffic = function (){
	...
	unsafeWindow.setActive = function(){
		var a = document.getElementById('activeSetter');
		if (active){
			active = false;
			a.innerHTML = "<img src=\"http://www.blueghost.pwp.blueyonder.co.uk/bg_site/google.png\" width=\"8\" height=\"16\" alt=\"Traffic Icon\" />&nbsp;<span>Load UK Traffic</span>";
			a.title		= "Load UK Traffic Data";
			removeAllTraffic();
		}else{
			active = true;
			a.innerHTML = "<img src=\"http://www.blueghost.pwp.blueyonder.co.uk/bg_site/google.png\" width=\"8\" height=\"16\" alt=\"Traffic Icon\" />&nbsp;<span>Hide UK Traffic</span>";
	...
	*/
	...
	lttp.parentNode.insertBefore(a, lttp.nextSibling);
})() 