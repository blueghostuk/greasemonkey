...
// select "BBC Radio Player Extra Controls Text Version", and click Uninstall.
//
...
window.ImgPlay = function (){
	//do nothing
}
/*overwrite existing as it want to access to non-existant playpause button*/
window.ImgPause = function (){
	//do nothing
}
...
if (more && (PlayerType !="live") && (src.length >0)) { //if is "speech" then don't need extra controls, or "live" can't have them
